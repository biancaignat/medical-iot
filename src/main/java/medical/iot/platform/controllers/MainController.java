...
public class MainController {
    ...
    @Autowired
    public MainController(final UserRepository userRepository, final InvestigationRepository investigationRepository, final DiagnosticRepository diagnosticRepository) {
    ...
    public String postAddDiagnostic(HttpServletRequest request) {
        ...
        String description = request.getParameter("diagnostic");
